...
/*   Updated: 2023/12/17 12:36:02 by abied-ch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_rays_horizontal(t_data *data)
{
	...
	line.x0 = ray.map_x * data->tile_width + data->tile_width / 2;
	line.y0 = ray.map_y * data->tile_height + data->tile_height / 2;
	...
	draw_line(data, line, 0x39ff14, 1);
}
...
void	draw_rays_vertical(t_data *data)
{
	...
	line.y1 = ray.reach_y * data->tile_height + data->tile_height / 2;
	calculate_distance(&ray, data);
	draw_line(data, line, 0xff0000, 1);
}
